...
export default function Home() {
  return (
    <>
      <Head></Head>
      <main>
        <div className="containcontainerhero bg-[url('/main/hero-award.jpg')] w-full bg-no-repeat bg-cover h-[800px]">
          <div className="containerhero  w-full bg-black/50 h-full flex items-center justify-center">
            <h1 className="text-6xl text-white font-extrabold leading-[80px] w-[80%]">
        ...
        <div className="aboutEnactus w-[80%] mx-auto my-32">
          ...
          <div className="flex flex-row justify-center items-center">
            <Image src="/main/logo.png" alt="Vercel Logo" width={300} height={300}  ></Image>
            <div className="flex flex-col w-[50%] ml-10">
              <p><b className="text-5xl text-yellow-600">EN</b> trepreneurial - having the perspective to see an opportunity and the talent to create value from that opportunity; </p>
            <p className="mt-4">        <b className="text-5xl text-yellow-600">ACT</b>ion - the willingness to do something and the commitment to see it through even when the outcome is not guaranteed; </p>
            <p className="mt-4"> <b className="text-5xl text-yellow-600">US</b>- a group of people who see themselves connected in some important way; individuals that are part of a greater whole..</p>
        
            </div>
              </div>
          <div className="grid grid-cols-3 grid-flow-row mb-24 mt-10 text-center gap-16">
        ...
        <div className="ourprojectcontainer my-32">
          ...
          <div className="grid grid-cols-2 grid-flow-row w-[90%] mx-auto gap-3 text-center mx-auto">
            ...
            <ProjectCard image="/files/vape drop/vapedrop_logo_edited.jpg" title="VapeDrop" content="ontarget" />
            <ProjectCard image="/files/all logos/OnTarget Logo.png" title="OnTarget" content="ontarget" />
            <ProjectCard image="/files/all logos/OnTarget Logo.png" title="OnTarget" content="ontarget" />
            <ProjectCard image="/files/all logos/OnTarget Logo.png" title="OnTarget" content="ontarget" />
          </div>
        </div>
