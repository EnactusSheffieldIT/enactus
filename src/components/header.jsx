      ...
      <>
        <header className={`flex flex-row justify-evenly items-center bg-transparent text-white top-0 z-30 whitetoyellow absolute w-[100%] ${isClick == true || pathname != "/"?"!bg-black": ""}  ${pathname != "/"?"!relative": ""}`}>
          ...
          <div className="menulink mt-5 hidden xl:inline">
            ...
            <Link href="/#about" className="p-2 border-t-2 m-5 border-teal-300 hover:text-yellow-400 hover:border-yellow-300 duration-150 text-2xl">About</Link>
            
            <div className="dropdown">
              <Link href="/#project" className="p-2 border-t-2 m-5 border-teal-300 hover:text-yellow-400 hover:border-yellow-300 duration-150 text-2xl">Projects
            ...
            <Link href="/#announcements" className="p-2 border-t-2 m-5 border-teal-300 hover:text-yellow-400 hover:border-yellow-300 duration-150 text-2xl">Announcements</Link>
            <Link href="/#contact" className="p-2 border-t-2 m-5 border-teal-300 hover:text-yellow-400 hover:border-yellow-300 duration-150 text-2xl">Contact</Link>
          </div>
          <div className="">
