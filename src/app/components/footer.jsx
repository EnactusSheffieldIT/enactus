        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="md:ml-12 flex flex-col max-w-[90vw]">
            ...
            <div className="flex flex-row [&>*]:mx-1 md:[&>*]:mx-5 my-2">
              ...
              <div className="w-[24px] invert logotoyellow"
                dangerouslySetInnerHTML={{
                  __html:
            ...
            <a className="underline text-blue-200 hover:text-yellow-500" href="mailto:contact@enactussheffield.org">Enactus Sheffield Contact</a>
            <h3>Phone:</h3>
            <a className="underline text-blue-200 hover:text-yellow-500" href="tel:+44011422244444">University of Sheffield Security Team</a>
          </div>
