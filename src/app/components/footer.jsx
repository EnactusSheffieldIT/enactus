    ...
    <footer>
      ...
      <div className="flex flex-col my-20 md:mb-0">
        ...
        <div className="md:ml-12 flex flex-col">
          ...
          <h3>Email:</h3>
          <a className="underline text-blue-500" href="mailto:contact@enactussheffield.org">Enactus Sheffield Contact</a>
          <h3>Phone:</h3>
          <a className="underline text-blue-500" href="tel:+44011422244444">University of Sheffield Security Team</a>
        </div>
