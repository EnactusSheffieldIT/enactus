      ...
      <div className="ourcontactcontainer w-full bg-black p-6">
        <div className="flex bg-white md:p-8 p-2 w-fit rounded-lg gap-10 mx-auto md:flex-row flex-col">
          <form method="post" action="https://docs.google.com/forms/d/e/1FAIpQLSdv9uVdvzgAM6tgta_mNhfJdxoV2lCD_dELjtDCABY28iHyWw/formResponse" ref={formRef} onSubmit={handleSubmit} className="rounded-lg flex flex-col gap-y-1 w-[90%] md:w-[600px] mx-auto mb-12">
            ...
            <input type="submit" disabled value="FORM CURRENTLY DISABLED" className="hover:cursor-pointer bg-blue-600 text-white mt-7 hover:bg-yellow-500 hover:border-transparent" />
            ...
            <div className="flex flex-col ">
              ...
              <div className="hidden md:block"
                dangerouslySetInnerHTML={{
                  __html:
                    '<div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="212" id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2379.84857658308!2d-1.4857545235266423!3d53.38175877229961!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4879827f5fa2c59b%3A0xbb0e179582dae894!2sElla%20Armitage%20Building!5e0!3m2!1sen!2suk!4v1757966129168!5m2!1sen!2suk" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><br><style>.mapouter{position:relative;text-align:right;height:212px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:212px;width:600px;}</style></div></div>',
                }} ></div>
              {/* <div className="md:hidden w-[90vw]"
                dangerouslySetInnerHTML={{
                  __html:
                    '<div class="mapouter"><div class="gmap_canvas"><iframe width="600" class="w-[90vw]" height="212" id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2379.84857658308!2d-1.4857545235266423!3d53.38175877229961!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4879827f5fa2c59b%3A0xbb0e179582dae894!2sElla%20Armitage%20Building!5e0!3m2!1sen!2suk!4v1757966129168!5m2!1sen!2suk" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><br><style>.mapouter{position:relative;text-align:right;height:212px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:212px;width:600px;}</style></div></div>',
                }} ></div> */}
            </div>
